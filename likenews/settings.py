"""
Django settings for likenews project.
...
SECRET_KEY = 'django-insecure-d*s=zs!9=31=%n8w031vccy)m#l5%*1)hjgke2d(lr*0gkej-7'
...
WSGI_APPLICATION = 'likenews.wsgi.application'
